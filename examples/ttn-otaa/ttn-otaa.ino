 ...
 *20201019modification on  LMIC_setTxData2(1, mydata, sizeof(mydata), 0);
 *20201019 add AS frequency plan:(right after LMIC_reset(); )
...
static uint8_t mydata[] ={0x00,0x01,0x02,0x03,0x04,0x05};
